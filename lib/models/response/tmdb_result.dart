...
//
//     final tmdbMovieResult = tmdbMovieResultFromJson(jsonString);

import 'dart:convert';

TmdbMovieResult tmdbMovieResultFromJson(String str) =>
    TmdbMovieResult.fromJson(json.decode(str));

String tmdbMovieResultToJson(TmdbMovieResult data) =>
